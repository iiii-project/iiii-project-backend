...
class BasicMemoryAgentConfig(I18nMixin, BaseModel):
    ...
    max_response_characters: int = Field(500, ge=1, alias="max_response_characters")
    ...
    DESCRIPTIONS: ClassVar[Dict[str, Description]] = {
        ...
        "max_response_characters": Description(
            en="Maximum characters allowed in one assistant response",
            zh="單次角色回覆允許的最大字元數",
        ),
    }
